...
urlpatterns = [
    ...
    *_routes("catalog-extensions", "catalogextension", models.CatalogExtension,
             views.CatalogExtensionListView, views.CatalogExtensionEditView, views.CatalogExtensionView,
             views.CatalogExtensionDeleteView, views.CatalogExtensionBulkDeleteView),
    ...
    *_routes("instance-extensions", "serviceinstanceextension", models.ServiceInstanceExtension,
             views.ServiceInstanceExtensionListView, views.ServiceInstanceExtensionEditView,
             views.ServiceInstanceExtensionView, views.ServiceInstanceExtensionDeleteView,
             views.ServiceInstanceExtensionBulkDeleteView),
    ...
    *_routes("host-roles", "hostrole", models.HostRole,
             views.HostRoleListView, views.HostRoleEditView, views.HostRoleView,
             views.HostRoleDeleteView, views.HostRoleBulkDeleteView),
    *_routes("rotation-policies", "rotationpolicy", models.RotationPolicy,
             views.RotationPolicyListView, views.RotationPolicyEditView, views.RotationPolicyView,
             views.RotationPolicyDeleteView, views.RotationPolicyBulkDeleteView),
    *_routes("host-role-params", "hostroleparam", models.HostRoleParam,
             views.HostRoleParamListView, views.HostRoleParamEditView, views.HostRoleParamView,
             views.HostRoleParamDeleteView, views.HostRoleParamBulkDeleteView),
    *_routes("host-role-assignments", "hostroleassignment", models.HostRoleAssignment,
             views.HostRoleAssignmentListView, views.HostRoleAssignmentEditView, views.HostRoleAssignmentView,
             views.HostRoleAssignmentDeleteView, views.HostRoleAssignmentBulkDeleteView),
    *_routes("host-role-assignment-vars", "hostroleassignmentvar", models.HostRoleAssignmentVar,
             views.HostRoleAssignmentVarListView, views.HostRoleAssignmentVarEditView,
             views.HostRoleAssignmentVarView, views.HostRoleAssignmentVarDeleteView,
             views.HostRoleAssignmentVarBulkDeleteView),
]
